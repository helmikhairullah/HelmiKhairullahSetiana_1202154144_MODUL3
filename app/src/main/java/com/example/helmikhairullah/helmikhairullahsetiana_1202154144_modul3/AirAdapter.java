...
public class AirAdapter extends RecyclerView.Adapter<AirAdapter.AirViewHolder> {
    ...
    public AirAdapter.AirViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new AirViewHolder(mContext, LayoutInflater.from(mContext).inflate(R.layout.recycleview, parent, false), mGradient);
    }
    ...
    class AirViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        AirViewHolder(Context context, View itemView, GradientDrawable gradientDrawable){
            ...
            mTitle = (TextView) itemView.findViewById(R.id.penjelasan);
            mInfo = (TextView) itemView.findViewById(R.id.judul);
